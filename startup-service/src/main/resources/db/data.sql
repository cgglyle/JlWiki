...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='登陆日志';
...
VALUES (1, 'admin', '2021-12-29 11:53:15', NULL, _binary '', NULL),
       (2, 'admin', '2021-12-29 13:31:17', NULL, _binary '', NULL),
       (3, 'admin', '2021-12-29 14:53:49', NULL, _binary '', NULL),
       (4, 'admin', '2021-12-29 15:21:44', NULL, _binary '', NULL),
       (5, 'test', '2021-12-29 17:11:35', NULL, _binary '', NULL),
       (6, 'admin', '2021-12-29 17:13:47', NULL, _binary '', NULL),
       (7, 'admin', '2021-12-29 17:20:28', NULL, _binary '', NULL),
       (8, 'admin', '2021-12-29 17:25:13', NULL, _binary '', NULL),
       (9, 'admin', '2021-12-30 09:19:30', NULL, _binary '', NULL),
       (10, 'admin', '2021-12-30 09:19:49', NULL, _binary '', NULL),
       (11, 'admin', '2021-12-30 09:37:53', NULL, _binary '', NULL),
       (12, 'admin', '2021-12-30 13:08:44', NULL, _binary '', NULL),
       (13, 'admin', '2021-12-30 13:08:50', NULL, _binary '', NULL),
       (14, 'admin', '2021-12-30 14:13:31', NULL, _binary '', NULL),
       (15, 'admin', '2021-12-30 15:34:11', NULL, _binary '', NULL),
       (16, 'admin', '2021-12-31 08:42:55', NULL, _binary '', NULL),
       (17, 'admin', '2021-12-31 13:59:53', NULL, _binary '', NULL),
       (18, 'test', '2021-12-31 14:34:30', NULL, _binary '', NULL),
       (19, 'admin', '2021-12-31 16:58:53', NULL, _binary '', NULL),
       (20, 'admin', '2022-01-04 09:05:03', NULL, _binary '', NULL),
       (21, 'admin', '2022-01-04 11:04:00', NULL, _binary '', NULL),
       (22, 'admin', '2022-01-05 09:36:18', NULL, _binary '\0', NULL),
       (23, 'admin', '2022-01-05 09:37:06', NULL, _binary '\0', NULL),
       (24, 'admin', '2022-01-05 09:38:32', NULL, _binary '\0', NULL),
       (25, 'admin', '2022-01-05 09:39:49', NULL, _binary '\0', NULL),
       (26, 'admin', '2022-01-05 09:47:28', NULL, _binary '\0', NULL),
       (27, 'admin', '2022-01-05 09:49:07', NULL, _binary '\0', NULL),
       (28, 'admin', '2022-01-05 09:55:43', NULL, _binary '', NULL),
       (29, 'admin', '2022-01-05 10:55:17', NULL, _binary '', NULL),
       (30, 'admin', '2022-01-05 11:52:53', NULL, _binary '', NULL);
/*!40000 ALTER TABLE `login_log`
    ENABLE KEYS */;
UNLOCK
    TABLES;
...
/*!40000 ALTER TABLE `operation_log`
    DISABLE KEYS */;
...
VALUES (1, '非法登陆', 'User', '/user/addUser', 'POST',
       ...
       (27, 'admin', 'User', '/user/updateUser', 'EXCEPTION',
        '{\"userUpdateDto\":{\"id\":\"4\",\"status\":true,\"userAge\":0,\"userEmail\":\"\",\"userFacebook\":\"\",\"userGender\":0,\"userGoogle\":\"\",\"userIcon\":\"\",\"userName\":\"testDeleted\",\"userNickName\":\"\",\"userPassword\":\"\",\"userPhone\":\"\",\"userQq\":\"\",\"userRealName\":\"\",\"userTelegram\":\"\",\"userTwitter\":\"\",\"userWechat\":\"\"}}',
        '更新用户失败', _binary '\0', '2022-01-04 14:07:08', -1),
       (28, 'admin', 'User', '/user/updateUser', 'EXCEPTION',
        '{\"userUpdateDto\":{\"id\":\"4\",\"status\":true,\"userAge\":0,\"userEmail\":\"\",\"userFacebook\":\"\",\"userGender\":0,\"userGoogle\":\"\",\"userIcon\":\"\",\"userName\":\"testDeleted\",\"userNickName\":\"\",\"userPassword\":\"\",\"userPhone\":\"\",\"userQq\":\"\",\"userRealName\":\"\",\"userTelegram\":\"\",\"userTwitter\":\"\",\"userWechat\":\"\"}}',
        '更新用户失败', _binary '\0', '2022-01-04 15:00:22', -1),
       (29, 'admin', 'User', '/user/updateUser', 'PUT',
        '{\"userUpdateDto\":{\"id\":\"4\",\"status\":true,\"userAge\":0,\"userEmail\":\"\",\"userFacebook\":\"\",\"userGender\":0,\"userGoogle\":\"\",\"userIcon\":\"\",\"userName\":\"testDeleted\",\"userNickName\":\"\",\"userPassword\":\"\",\"userPhone\":\"\",\"userQq\":\"\",\"userRealName\":\"\",\"userTelegram\":\"\",\"userTwitter\":\"\",\"userWechat\":\"\"}}',
        'true', _binary '', '2022-01-04 15:44:36', 4256),
       (30, 'admin', 'User', '/user/addUser', 'POST',
       ...
       (31, 'admin', 'UserRole', '/user/addUserRole', 'POST',
        '{\"userRoleRelationAddDto\":{\"createUser\":1,\"roleId\":1,\"userId\":5}}', 'true', _binary '',
        '2022-01-04 15:53:44', 50),
       (32, 'admin', 'User', '/user/deleteUser/5', 'DELETE', '{\"id\":\"5\"}', 'true', _binary '',
        '2022-01-04 15:53:54', 26),
       (33, 'admin', 'User', '/user/batchDeleteUser', 'DELETE', '{\"idList\":[4,5]}', 'true', _binary '',
        '2022-01-04 15:54:40', 17),
       (34, 'admin', 'User', '/user/getPage', 'GET', '{\"userQuery\":{\"pageNum\":1,\"pageSize\":20}}',
       ...
       (46, 'admin', 'Permission', '/permission/add', 'POST',
...
VALUES (1, '用户查询', '/user/getPage', '2021-12-29 15:01:32', '2021-12-29 15:01:32', 1, NULL, _binary '', _binary '',
        _binary ''),
       (2, '添加用户', '/user/addUser', '2021-12-29 15:03:53', '2021-12-29 15:03:53', 1, NULL, _binary '', _binary '',
        _binary ''),
       (3, '删除用户', '/user/deleteUser', '2021-12-31 16:11:13', '2021-12-31 16:11:13', 1, NULL, _binary '', _binary '',
        _binary ''),
       (4, '错误页', '/cp/error', NULL, NULL, 1, NULL, _binary '', _binary '', _binary ''),
       (5, '登陆', '/login', NULL, NULL, 1, NULL, _binary '', _binary '', _binary ''),
       (6, '权限查看', '/permission/get', '2021-12-31 17:26:50', '2021-12-31 17:26:50', 0, NULL, _binary '', _binary '',
        _binary ''),
       (7, '更新用户', '/user/updateUser', '2022-01-05 10:58:09', '2022-01-05 10:58:09', 1, NULL, _binary '', _binary '',
        _binary ''),
       (8, '批量删除用户', '/user/batchDeleteUser', '2022-01-05 10:58:37', '2022-01-05 10:58:37', 1, NULL, _binary '',
        _binary '', _binary ''),
       (9, '给予角色', '/user/addUserRole', '2022-01-05 10:59:33', '2022-01-05 10:59:33', 1, NULL, _binary '', _binary '',
        _binary ''),
       (10, '移除角色', '/user/deleteUserRole', '2022-01-05 11:00:17', '2022-01-05 11:00:17', 1, NULL, _binary '',
        _binary '', _binary ''),
       (11, '修改密码', '/user/updateUserPassword', '2022-01-05 11:00:42', '2022-01-05 11:00:42', 1, NULL, _binary '',
        _binary '', _binary ''),
       (12, '获取角色分页', '/role/getPage', '2022-01-05 11:01:27', '2022-01-05 11:01:27', 1, NULL, _binary '', _binary '',
        _binary ''),
       (13, '添加角色', '/role/addRole', '2022-01-05 11:01:41', '2022-01-05 11:01:41', 1, NULL, _binary '', _binary '',
        _binary ''),
       (14, '删除角色', '/role/deleteRole', '2022-01-05 11:02:03', '2022-01-05 11:02:03', 1, NULL, _binary '', _binary '',
        _binary ''),
       (15, '更新角色', '/role/updateRole', '2022-01-05 11:02:18', '2022-01-05 11:02:18', 1, NULL, _binary '', _binary '',
        _binary ''),
       (16, '批量删除角色', '/role/batchDeleteRole', '2022-01-05 11:02:45', '2022-01-05 11:02:45', 1, NULL, _binary '',
        _binary '', _binary ''),
       (17, '添加角色权限的', '/role/addRolePermission', '2022-01-05 11:03:19', '2022-01-05 11:03:19', 1, NULL, _binary '',
        _binary '', _binary ''),
       (18, '添加权限', '/permission/add', '2022-01-05 11:04:00', '2022-01-05 11:04:00', 1, NULL, _binary '', _binary '',
        _binary ''),
       (19, '登出', '/logout', '2022-01-05 11:04:44', '2022-01-05 11:04:44', 1, NULL, _binary '', _binary '',
        _binary '');
/*!40000 ALTER TABLE `permission`
    ENABLE KEYS */;
UNLOCK
...
VALUES (1, 'admin', '管理员权限，拥有所有权限', NULL, '2021-12-29 13:54:49', '2022-01-04 08:45:43', 1, NULL, _binary '',
        _binary '', _binary ''),
       (2, 'test', '测试员，拥有测试权限', NULL, '2021-12-29 13:55:16', '2021-12-29 13:58:38', 1, NULL, _binary '', _binary '',
        _binary ''),
       (3, 'anonymous', '匿名用户，无权限', NULL, '2021-12-29 13:55:36', '2021-12-31 15:06:51', 1, NULL, _binary '',
        _binary '', _binary '');
/*!40000 ALTER TABLE `role`
    ENABLE KEYS */;
UNLOCK
...
/*!40000 ALTER TABLE `role_permission_relation`
    DISABLE KEYS */;
...
VALUES (1, 1, 1, '2021-12-29 15:22:08', '2021-12-29 15:22:08', 1, NULL, _binary '', _binary '', _binary '\0'),
       (2, 1, 2, '2021-12-29 15:22:13', '2021-12-29 15:22:13', 1, NULL, _binary '', _binary '', _binary '\0'),
       (3, 2, 1, '2021-12-31 14:17:10', '2021-12-31 14:17:10', 1, NULL, _binary '', _binary '', _binary '\0'),
       (9, 1, 3, '2021-12-31 16:12:10', '2021-12-31 16:12:10', 1, NULL, _binary '', _binary '', _binary '\0'),
       (10, 3, 4, NULL, NULL, 1, NULL, _binary '', _binary '', _binary ''),
       (11, 3, 5, NULL, NULL, 1, NULL, _binary '', _binary '', _binary ''),
       (12, 1, 6, '2021-12-31 17:28:52', '2021-12-31 17:28:52', 1, NULL, _binary '', _binary '', _binary '\0');
/*!40000 ALTER TABLE `role_permission_relation`
    ENABLE KEYS */;
UNLOCK
    TABLES;
...
VALUES (1, 'admin', '$2a$10$EthbHmZa588wUZJqWxmZrObybDjim7ddRYJfa1Ln.WOqlODtLs8Su', '2021-12-29 11:30:18', '阿撒托斯', 2, 0,
       ...
       (2, 'test', '$2a$10$iAExDKGyUpRVL9NsGf0YsOHp4US9tF7bAoO0fmeauVVK9QsdYjdUm', '2021-12-29 11:50:57', '人类', 2, 0,
        '测试员', 'url://test', 'test@jwiki.com', '44455556666', '2965522699', '', '', '', '', '', '2021-12-29 11:50:57',
        '2021-12-29 13:58:25', NULL, NULL, NULL, 1, _binary '', _binary '', _binary ''),
       (3, 'anyone', '$2a$10$kPuwWgNKh7Z2F/r/ueApKOf37g01e7grSoeNnE36lht4f4AjZYWa.', '2021-12-29 11:52:50', 'D级人员', 2,
       ...
       (4, 'testDeleted', '', NULL, '', 0, 0, '', '', '', '', '', '', '', '', '', '', '2021-12-31 16:09:59',
        '2022-01-04 15:54:39', NULL, NULL, NULL, NULL, _binary '', _binary '\0', _binary '\0'),
       (5, 'testAccount', '', NULL, '', 0, 0, '', '', '', '', '', '', '', '', '', '', '2022-01-04 15:45:46',
        '2022-01-04 15:54:39', NULL, NULL, NULL, NULL, _binary '', _binary '\0', _binary '\0');
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK
...
/*!40000 ALTER TABLE `user_group_relation`
    DISABLE KEYS */;
/*!40000 ALTER TABLE `user_group_relation`
    ENABLE KEYS */;
UNLOCK
...
/*!40000 ALTER TABLE `user_role_relation`
    DISABLE KEYS */;
INSERT INTO `user_role_relation`
VALUES (1, 1, 1, '2021-12-29 13:57:16', '2021-12-29 13:58:14', 1, NULL, _binary '', _binary '', _binary ''),
       (2, 2, 2, '2021-12-29 13:57:34', '2021-12-29 13:58:14', 1, NULL, _binary '', _binary '', _binary ''),
       (3, 3, 3, '2021-12-29 13:57:44', '2021-12-29 13:58:14', 1, NULL, _binary '', _binary '', _binary ''),
       (4, 4, 1, '2022-01-04 09:20:31', '2022-01-04 09:20:31', 1, NULL, _binary '', _binary '', _binary '\0'),
       (5, 4, 2, '2022-01-04 09:28:14', '2022-01-04 09:28:14', 1, NULL, _binary '', _binary '', _binary '\0'),
       (6, 5, 1, '2022-01-04 15:53:44', '2022-01-04 15:53:44', 1, NULL, _binary '', _binary '', _binary '\0'),
       (7, 7, 1, '2022-01-05 10:06:35', '2022-01-05 10:06:35', 1, NULL, _binary '', _binary '', _binary '\0');
/*!40000 ALTER TABLE `user_role_relation`
    ENABLE KEYS */;
UNLOCK
    TABLES;
...
-- Dump completed on 2022-01-05 13:09:54
