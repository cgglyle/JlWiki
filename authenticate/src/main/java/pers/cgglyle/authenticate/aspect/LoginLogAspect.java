package pers.cgglyle.authenticate.aspect;
...
public class LoginLogAspect {
     ...
     * 登陆日志切入点
     */
    @Pointcut("@annotation(pers.cgglyle.authenticate.annotaion.LoginLog)")
     ...
     * 登出日志切入点
     */
    @Pointcut("@annotation(pers.cgglyle.authenticate.annotaion.LogoutLog)")
