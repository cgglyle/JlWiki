package pers.cgglyle.service.account.aspect;
...
public class LoginLogAspect {
     ...
     * 登陆日志切入点
     */
    @Pointcut("@annotation(pers.cgglyle.service.account.annotaion.LoginLog)")
     ...
     * 登出日志切入点
     */
    @Pointcut("@annotation(pers.cgglyle.service.account.annotaion.LogoutLog)")
